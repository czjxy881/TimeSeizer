...
public class ListActivity extends ActionBarActivity implements ActionBar.OnNavigationListener {
    ...
    public boolean onNavigationItemSelected(int position, long id) {
        ...
        Fragment s;
        switch (position){
            case 0:s=new RightFragment();break;
            case 1:s=new LeftFragment();break;
            case 2:s=new ListFragment1();break;
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        @Override
        public View onCreateView(LayoutInflater inflater, ViewGroup page,
