...
import com.example.app.ListFragment1;
...
public class NotepadAdapter extends BaseAdapter {
    ...
    public View getView(int arg0, View arg1, ViewGroup arg2) {
        ...
        setShow.styleButtonStart=(Button)arg1.findViewById(R.id.stylebutton3);
        ...
        setShow.styleButtonStart
                .setOnClickListener(new StartButtonListener(arg0));
    ...
    class StartButtonListener implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.setClass(context1,CenterActivity.class);
